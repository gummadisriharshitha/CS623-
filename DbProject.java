	...
	public class DbProject {
	    ...
	    public void setConnection() {
	        try {
	            ...
	            conn = DriverManager.getConnection("jdbc:postgresql://localhost:5432/css623", "postgres", "Postgre@2707");
	    ...
	    private void insertDepotValues() throws SQLException {
	        ...
	        query.execute("INSERT INTO depot VALUES('D100', 'Chicago', 100)");
	        query.close();
	    }
	    ...
	    private void insertStockValues() throws SQLException {
	        ...
	        query.execute("INSERT INTO stock VALUES('P1', 'D100', 100)");
	        query.close();
	    }
	    ...
	    public static void main(String args[]) {
	        DbProject project_demo = new DbProject();
